...
public class ImageAnalyzeDB implements BaseColumns {
	...
	public static final String KEY_EIGEN_COLS ="imageEigenCols" ;
	public static final String KEY_OMEGA_COLS ="imageOmegaCols" ;
	...
	public static final ArrayList<String> createQueryKeys () {
		...
		list.add (KEY_EIGEN_COLS + " INTEGER NOT NULL,") ;
		list.add (KEY_OMEGA_COLS + " INTEGER NOT NULL,") ;
